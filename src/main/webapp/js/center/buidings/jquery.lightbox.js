	...
	$.fn.lightbox = function(options) {
		...
		*/
		function initialize() {
			...
			var outerImage = '<div id="outerImageContainer"><div id="imageContainer"><iframe id="lightboxIframe"></iframe><img id="lightboxImage" /><div id="hoverNav"><a href="javascrcommon_ipt://" title="' + opts.strings.prevLinkTitle + '" id="prevLink"></a><a href="javascrcommon_ipt://" id="nextLink" title="' + opts.strings.nextLinkTitle + '"></a></div><div id="loading"><a href="javascrcommon_ipt://" id="loadingLink"><img src="'+opts.fileLoadingImage+'"></a></div></div></div>';
			...
			imageData += '<a href="javascrcommon_ipt://" id="bottomNavClose" title="' + opts.strings.closeTitle + '"><img src="'+opts.fileBottomNavCloseImage+'"></a></div></div></div>';
