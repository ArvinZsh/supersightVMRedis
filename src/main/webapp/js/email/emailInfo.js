            ...
            success: function(data){
                if(data.successFlag){
                   ...
                   this.setState({emailInfo:data.receiverData});
                    ...
                    layer.alert("初始化失败！",data.errorMsg,{icon:2});
                }
            }.bind(this),
    ...
    render:function render(){
        ...
        if(this.state.emailInfo==""||typeof (this.state.emailInfo)==undefined||this.state.emailInfo==null){
            this.state.emailInfo.fileList.map(function(data){
                file.push(React.createElement("a",{className:"emailInfo_a",src:data.filePath},data.fileName));
            });
        }
       ...
       return( React.createElement(
            ...
            React.createElement("div",{ id: "" },
                ...
                React.createElement("p",{className:"emailInfo-modal_p",id:"emailInfo-modal_content"},
                    ...
                    React.createElement("label",{id:"emailInfo-Cintent",className:"emailInfo-modal_input"},this.state.emailInfo.shortContent)
                ),
