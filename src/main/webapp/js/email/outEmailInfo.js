...
var emailInfo=React.createClass({
    ...
    componentWillMount:function(){
        ...
        var tmp = {"sid":sid,"mailId":this.state.emailId};
        var tmp1  = JSON.stringify(tmp);
        $.ajax({
            url:common_ip+"mail.do?action=getSendDetail",
            dataType:'json',
            data:tmp1,
            type:'post',
            ...
            success: function(data){
                if(data.successFlag){
                   ...
                   this.setState({emailInfo:data.sendData});
    ...
    render:function render(){
       ...
       return( React.createElement(
            ...
            React.createElement("div",{ id: "" },
                ...
                React.createElement("p",{className:"emailInfo-modal_p"},
                    React.createElement("label",{className:"emailInfo-modal_label"},"收件人" ),
                    React.createElement("label",{className:"emailInfo-modal_input",id:"hints_address",onClick:this.addresseeClick},this.state.emailInfo.receiverList)
                ) ,
                React.createElement("p",{className:"emailInfo-modal_p"},
