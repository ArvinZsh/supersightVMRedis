...
//	        var O = "鼠牛虎兔龙蛇马羊猴鸡狗猪";
	        ...
	        function U(Y) {
	            ...
	            this.showInLunar = (this.lunarFestival == "") ? this.showInLunar
	                    : this.lunarFestival;
	            this.showInLunar = (this.showInLunar.length > 2) ? this.showInLunar
	                    .substr(0, 2)
	                    + "..." : this.showInLunar
	        }
	        var Q = (function() {
	        ...
	        var N = (function() {
	            function C() {
	                var Z = Q.getJson();
	                var c = Z.dateArray;
	                M("cm").style.height = Z.lines * 24 + 2 + "px";
	                M("cm").innerHTML = "";
	                for ( var a = 0; a < c.length; a++) {
	                    ...
	                    if (c[a].isToday) {
	                        ...
	                        X.style.border = "1px solid #0093dc";
	                        X.style.background = "#0093dc";
	                    }
	                    X.className = "cell";
	                    // 调关键样式
	                    X.style.left = (a % 7) * 25 + "px";
	                    X.style.top = Math.floor(a / 7) * 19 + "px";
	                    var b = R("DIV");
	                    b.className = "so";
	                    // http://www.CsrCode.Cn
	                    // 显示日期的部分颜色
...
//	                    Y.innerHTML = c[a].showInLunar;
	...
	{
		return(
			React.createElement("div",{id:"cladid"},
			React.createElement("table",{cellpadding:"0",cellspacing:"0",id:"tabcalid"},
				React.createElement("tr",null,
					React.createElement("td",null,
						React.createElement("div",{id:"cal"},
							React.createElement("div",{id:"top"},
									React.createElement("lable",null,""),
									React.createElement("select",{id:"selid1"}),
									React.createElement("lable",null," 年  "),
									React.createElement("select",{id:"selid2"}),
									React.createElement("lable",null," 月  "),
									React.createElement("span",null),
									React.createElement("lable",null,""),
									React.createElement("span",null),
									React.createElement("lable",null,""),
								React.createElement("input",{type:"button",value:" 回今",title:"点击后跳转到今天",style:{padding: "0px",width:""}})
							),
							React.createElement("ul",{id:"wk"},
								React.createElement("li",null,"一"),
								React.createElement("li",null,"二"),
								React.createElement("li",null,"三"),
								React.createElement("li",null,"四"),
								React.createElement("li",null,"五"),
								React.createElement("li",null,
									React.createElement("b",null,"六")
								),
								React.createElement("li",null,
									React.createElement("b",null,"日")		
								)
							),
							React.createElement("div",{id:"cm"}),
							React.createElement("div",{id:"bm"})
						)
					)
				)
			)
...
//ReactDOM.render(React.createElement(Calendar), document.getElementById("cladid"));